            ...
            <div className='flex gap-8 w-full mb-4 flex-wrap'>
              {dataTest.size.map((item, idx) => (
                <button
                  ...
                  }  leading-[100%] flex-1 p-[10px] cursor-pointer hover:bg-(--secondary-color) hover:text-[#0B0909]`}
                >
                  {item}
                </button>
              ))}
                ...
                <button
                  ...
                  className={`${
                    order.toping === item
                      ? "border border-(--secondary-color) bg-(--secondary-color) text-[#0B0909] font-semibold"
                      : "border border-(--color-white) text-[#4F5665] font-medium"
                  }  leading-[100%] flex-1 p-[10px] cursor-pointer hover:bg-(--secondary-color) hover:text-[#0B0909] hover:font-semibold `}
                >
                  {item}
                </button>
              ))}
