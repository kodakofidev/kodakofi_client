  ...
  return (
    <div className='relative w-full h-full mt-20'>
      <div className='w-[370px] max-w-[370px] h-[370px] max-h-[370px] bg-[#FF8906]'>
        <div className='h-[370px] max-h-[370px] w-[370px] max-w-[370px]'>
          <img
      ...
      <div className='flex flex-col gap-[40vh] p-5 absolute top-0'>
        <div className='bg-[#D00000] rounded-full text-white text-center w-[150px] px-3 py-2 font-lg font-bold'>
          FLASH SALE
        </div>
        <div className='bg-white flex flex-col gap-[10px] p-5 w-full max-w-[330px]'>
          ...
          <div className='flex flex-row gap-[10px]'>
            ...
            <button className='border border-[#FF8906] rounded-md p-2 w-1/10 flex flex-col items-center justify-center'>
